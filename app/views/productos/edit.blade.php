	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
		   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-offset-3">
		   		<form action="{{ URL::to('/productos/actualizar/'.$producto->id) }}" method="POST" role="form">
		   			<div class="form-group">
		   				<label for="codigo">Codigo</label>
		   				<input name="codigo" type="text" class="form-control" id="codigo" value="{{ $producto->codigo }}">
		   			</div>
		   			<div class="form-group">
		   			...
		   			<div class="form-group">
		   				...
		   				<input name="marca" type="text" class="form-control" id="marca" value="{{ $producto->marca }}">
		   			</div>
		   			<div class="form-group">
		   				<label for="modelo">Modelo</label>
		   				<input name="modelo" type="text" class="form-control" id="modelo" value="{{ $producto->modelo }}">
		   			</div>
		   			<div class="form-group">
		   			...
		   			<div class="form-group">
		   				...
		   				<textarea name="descripcion" class="form-control" id="descripcion" cols="30" rows="5" style="resize: none;">
